...
#include "c:/soul/include/soul/soul_patch.h"
#include "c:/soul/include/soul/patch/helper_classes/soul_patch_AudioProcessor.h"
#include "c:/soul/include/soul/patch/helper_classes/soul_patch_Utilities.h"
#include "c:/soul/include/soul/patch/helper_classes/soul_patch_CompilerCacheFolder.h"
	...
	namespace patch
	{
		...
		*/
		...
		public:
			...
			{
				Editor(CustomPatchLoader& p) : juce::AudioProcessorEditor(p), owner(p)
				{
		...
		private:
			...
			JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CustomPatchLoader)
		};


		//==============================================================================
		/** This helper class can be used as the template class for CustomPatchLoader to make it
